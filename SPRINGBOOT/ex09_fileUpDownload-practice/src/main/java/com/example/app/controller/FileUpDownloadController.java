...
public class FileUpDownloadController {
	...
	@PostMapping("/upload")
	public void upload(@RequestParam("files") MultipartFile[] files) throws Exception, IOException {
		log.info("POST /file/upload.." + " 갯수 : " + files.length);
	...
	public String upload(FileDto dto) throws Exception, IOException {
