...
<%
	...
	cookie1.setPath("/"); // 현재 도메인 내 모든 URI에 전달(모든 페이지로 해당 쿠키 전달). 즉 C01, C02 등 모든 페이지에 전달
	
	Cookie cookie2 = new Cookie("c2","v2");
	cookie2.setMaxAge(60*10);
	cookie1.setPath("./"); // 현재 패키지 내에 있는 페이지로만 전달. 즉 C07/02 에만 전달
