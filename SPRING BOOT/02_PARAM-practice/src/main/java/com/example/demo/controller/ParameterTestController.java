...
public class ParameterTestController {
	...
	public void page01(PersonDto dto, Model model) {
		...
		model.addAttribute("com/example/demo/domain/dto", dto);
	...
	public String page02(PersonDto dto, Model model) {
		...
		// 반환자료형이 String일때 /WEB-INF/views/param/page02.jsp와 매핑
	...
	public ModelAndView page04(PersonDto dto) {
		...
		modelAndView.addObject("com/example/demo/domain/dto", dto);
	...
	public String page05(HttpServletRequest req, HttpServletResponse resp) {
		...
		req.setAttribute("com/example/demo/domain/dto", dto);
